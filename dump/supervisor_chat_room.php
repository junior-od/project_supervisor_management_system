	...
	<div class="row">
		...
		<div class="col-sm-9 body_supervisor">
			...
			<div class="message_box">
				<a href="supervisor_messages.php"><i style="font-size:20px;" class="fa fa-angle-left" aria-hidden="true">  <?php echo $_SESSION['sender']; ?></i></a><br>
				...
				<form action="supervisor_chat_send.php" method="get">
