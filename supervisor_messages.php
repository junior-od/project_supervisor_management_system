            ...
            <div class="container-fluid"> 
                <div class="row">
					...
					foreach ($get_inbox_table_fetch as $d) {
							...
							echo'<li>
									<div class="row">
										...
										echo '<div class="col-xs-3 text-right">';
											echo "<a href='supervisor_messages_get.php?sender=$sender'><btn class='btn btn-sm btn-success btn-icon'><i class='fa fa-envelope'></i></btn><sup style='color:red;'>".$get_unopen_count."</sup></a>";
										echo '</div>
									</div>
								</li>';
					    ...
					    //  echo "<td> <a href='supervisor_chat_room.php?sender=$sender' class='inbox_button'><i class='fa fa-angle-right'></i></td>";
					 echo "</tr>";
